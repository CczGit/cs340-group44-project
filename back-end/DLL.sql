...
-- -----------------------------------------------------
-- Table structure for table `Composers_has_Developers`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `Composers_has_Developers` ;

CREATE TABLE IF NOT EXISTS `Composers_has_Developers` (
  `idComposer` INT NOT NULL,
  `idDeveloper` INT NOT NULL,
  PRIMARY KEY (`idComposer`, `idDeveloper`),
  INDEX `fk_Composers_has_Developers_Developers1_idx` (`idDeveloper` ASC) VISIBLE,
  INDEX `fk_Composers_has_Developers_Composers1_idx` (`idComposer` ASC) VISIBLE,
  CONSTRAINT `fk_Composers_has_Developers_Composers1`
    FOREIGN KEY (`idComposer`)
    REFERENCES `Composers` (`idComposer`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_Composers_has_Developers_Developers1`
    FOREIGN KEY (`idDeveloper`)
    REFERENCES `Developers` (`idDeveloper`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
...
-- -----------------------------------------------------
-- Dumping data for table `Composers_has_Developers`
-- -----------------------------------------------------

INSERT INTO Composers_has_Developers (idComposer, idDeveloper) VALUES (1,1),(2,2),(12,2),(3,3),(3,10),(4,4),(5,5),(6,7),(7,6),(8,5),(9,5),(10,8),(11,2);

-- -----------------------------------------------------
-- Table structure for table `Games_has_Composers`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `Games_has_Composers` ;

CREATE TABLE IF NOT EXISTS `Games_has_Composers` (
  `idGame` INT NOT NULL,
  `idComposer` INT NOT NULL,
  PRIMARY KEY (`idGame`, `idComposer`),
  INDEX `fk_Games_has_Composers_Composers1_idx` (`idComposer` ASC) VISIBLE,
  INDEX `fk_Games_has_Composers_Games1_idx` (`idGame` ASC) VISIBLE,
  CONSTRAINT `fk_Games_has_Composers_Games1`
    FOREIGN KEY (`idGame`)
    REFERENCES `Games` (`idGame`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_Games_has_Composers_Composers1`
    FOREIGN KEY (`idComposer`)
    REFERENCES `Composers` (`idComposer`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
...
-- -----------------------------------------------------
-- Dumping data for table `Games_has_Composers`
-- -----------------------------------------------------

INSERT INTO Games_has_Composers (idComposer, idGame) VALUES (1,1),(2,2),(12,2),(3,3),(3,10),(4,4),(5,5),(6,7),(7,6),(8,7),(9,8),(10,9),(11,2);

-- -----------------------------------------------------
-- Table structure for table `Composers_has_Songs`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `Composers_has_Songs` ;

CREATE TABLE IF NOT EXISTS `Composers_has_Songs` (
  `idComposer` INT NOT NULL,
  `idSong` INT NOT NULL,
  PRIMARY KEY (`idComposer`, `idSong`),
  INDEX `fk_Composers_has_Songs_Songs1_idx` (`idSong` ASC) VISIBLE,
  INDEX `fk_Composers_has_Songs_Composers1_idx` (`idComposer` ASC) VISIBLE,
  CONSTRAINT `fk_Composers_has_Songs_Composers1`
    FOREIGN KEY (`idComposer`)
    REFERENCES `Composers` (`idComposer`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_Composers_has_Songs_Songs1`
    FOREIGN KEY (`idSong`)
...
-- -----------------------------------------------------
-- Data dump for table `Composers_has_Songs`
-- -----------------------------------------------------

INSERT INTO Composers_has_Songs (idSong, idComposer) VALUES (1, 1),(2, 2),(2, 12),(3, 3),(3, 10),(4, 4),(5, 5),(6, 6),(7, 7),(8, 8),(9, 10),(10, 9),(11, 3),(11, 10),(12, 4),(13, 4),(14, 4),(15, 4),(16, 4),(17, 4),(18, 4),(19, 4),(20, 4),(21, 4),(22, 4),(23, 4),(24, 4),(25, 4),(26, 4),(27, 4),(28, 4),(29, 4),(30, 4),(31, 4),(32, 4),(33, 4),(34, 4),(35, 5),(36, 5),(37, 5),(38, 5),(39, 5),(40, 5),(41, 5),(42, 5),(43, 5),(44, 5),(45, 5),(46, 5),(47, 5),(48, 5),(49, 5),(50, 5),(51, 5),(52, 5),(53, 5),(54, 5),(55, 5),(56, 5),(57, 5),(58, 5),(59, 5),(60, 5),(61, 5),(62, 5),(63, 5),(64, 5),(65, 5),(66, 5),(67, 5),(68, 5),(69, 5),(70, 5),(71, 5),(72, 5),(73, 5),(74, 5),(75, 5),(76, 5),(77, 5),(78, 5),(79, 5),(80, 5),(81, 5),(82, 5),(83, 5),(84, 5),(85, 5),(86, 5),(87, 6),(88, 6);
...
-- INNER JOIN Composers_has_Songs on Composers_has_Songs.idSong     = Songs.idSong
-- INNER JOIN Composers           on Composers_has_Songs.idComposer = Composers.idComposer
